...
<div class="px-4 py-2 flex items-center space-x-2 text-gray-600">
  <button class="text-xs mr-5">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 -ml-5">
  ...
  <div class="text-sm flex">
    ...
    <span class="text-blue-500">Videos</span>
  </div>
</div>
